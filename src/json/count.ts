...
export interface CountJsonLinesOptions {
  readonly signal?: AbortSignal;
  readonly onProgress?: (progress: JsonLineCountProgress) => void;
  readonly progressIntervalMs?: number;
  readonly chunkSize?: number;
}

export interface JsonLineCountProgress {
...
export async function countJsonLines(
  filePath: string,
  options: CountJsonLinesOptions = {}
): Promise<number> {
